        ...
        <Row className="g-1 d-flex justify-content-between ">
          ...
          <Card style={{ width: "20rem" , height: "11rem" ,color:"white" ,backgroundColor:"transparent"}} className="rounded-0">
            <Card.Body>
              ...
              <Card.Text>
                <i class="fa-solid fa-location-dot"></i> FC Road Pune
              </Card.Text>
              <Card.Text>
                <i class="fa-solid fa-phone"></i> +91 8811223344
              </Card.Text>
              <Card.Text>
                <i class="fa-solid fa-envelope"></i> mavchi1212@gmail.com
              </Card.Text>
            </Card.Body>
          </Card>
        </Row>
        <Row>
          ...
          <div className="g-1 d-flex justify-content-center">
            <span style={{ color: "#ffffff" }}>
              ...
              2023 All Rights Reserved. Shilesh Mavchi
            </span>
          </div>
          </Col>
        </Row>
